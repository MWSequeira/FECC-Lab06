...
const alphabetInArrayOne = alphabetString.split();
console.log("The letters are one element in this array: ")
console.log(alphabetInArrayOne);

const alphabetInArrayEach = alphabetString.split("");
console.log("Each letter is an element in this array: ")
console.log(alphabetInArrayEach);
...
const reversedAlphaArray = alphabetArray.reverse();
console.log(reversedAlphaArray);

//this makes a string of the entire array:
console.log("This is a string of the entire array:")
console.log(reversedAlphaArray.toString());

//this concatenates the elements of the array:
console.log("The elements of the array, concatenated: ")
console.log(reversedAlphaArray.join(""));
...
console.log("Step 2");
console.log("The third element of the array is " + array1.at(2));

console.log("Step 3");
// Duh -- the array starts at zero, so the index of the last element is the length minus 1.
console.log("The last element is " + array1.at(array1.length-1));
